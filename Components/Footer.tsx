        ...
        <div className="grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]">
            <div className="flex items-center space-x-6">
                ...
                <div className="text-[25px] mb-[0.2rem] font-semibold text-[white]">
                    <h1>Address</h1>
                    <p className="text-[17px] w-[90%] text-white opacity-60">No.(110), 40th Street, 
                    6 Block, <br />Pyin Oo Lwin, Mandalay, Myanmar</p>
                </div>
            </div>
            <div className="flex items-center space-x-6">
                <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
                ...
                <div className="text-[25px] mb-[0.2rem] font-semibold text-[white]">
                    <h1>Phone</h1>
                    <p className="text-[17px] w-[90%] text-white opacity-60">+959970828303</p>
                </div>
            </div>
            <div className="flex items-center space-x-6">
                <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
                ...
                <div className="text-[25px] mb-[0.2rem] font-semibold text-[white]">
                    <h1>Send Us Email</h1>
                    <p className="text-[17px] w-[90%] text-white opacity-60">aungkyawzin.pol.mm@gmail.com</p>
                </div>
            </div>
        </div>
